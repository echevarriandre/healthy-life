<template>
  <div class="relative flex flex-col">
    <input
      ...
      :class="[
        ...inputClasses,
        'peer rounded-lg border-2 border-transparent bg-slate-100 px-4 pb-2 pt-5 placeholder-transparent transition duration-300 focus:border-pink-400 focus:bg-white focus-visible:outline-none disabled:text-slate-600',
